...
// Fragmento responsável por exibir as séries disponíveis em diferentes plataformas de streaming
class SeriesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Inicializar a GridView que mostrará as séries disponíveis
        val gridView = view.findViewById<GridView>(R.id.gridseries)
        ...
        // Lista de nomes de plataformas de streaming
        val text = listOf("Netflix", "Disney+", "Prime Video", "Apple+", "HBO MAX", "Globo Play", "STAR+", "Paramount+")
        // Lista de cores associadas a cada plataforma
        val cor = listOf(
            R.color.cor1,
            R.color.cor2,
            R.color.cor3,
        ...
        // Inicializar o adaptador da GridView com os dados das plataformas e cores correspondentes
